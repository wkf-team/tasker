...
<tr>
	<td>
		...
		<?php echo CHtml::link("Open", array("ticket/view", "id" => $data->id), array("class" => "btnOpen"))?>
		<?php
	...
	?></td>
	<td><?php 
		if ($data->ticket_type_id != 1) echo "<span class='ui-icon ui-icon-carat-1-sw' style='display:inline-block;'></span>";
