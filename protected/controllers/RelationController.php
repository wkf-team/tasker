...
class RelationController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Relation']))
		{
			...
			if($model->save())
				$this->redirect(array('ticket/view','id'=>($_POST['direction'] == "from" ? $model->ticket_from_id : $model->ticket_to_id)));
		}
		$direction = "test";
		
		if (isset($_GET['ticket_from_id'])) {
			$model->ticket_from_id = (int)$_GET['ticket_from_id'];
			$direction = "from";
		}
		
		if (isset($_GET['ticket_to_id'])) {
			$model->ticket_to_id = (int)$_GET['ticket_to_id'];
			$direction = "to";
		}
